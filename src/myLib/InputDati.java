...
public class InputDati 
{
	...
	public static int leggiIntero (String messaggio)
	  {
	   ...
	   do
	    {
	     System.out.print(messaggio);
	     if (lettore.hasNextInt())				//se � un int
	      {
	...
	/** 
	 * Questo metodo serve per leggere pi� valori interi e salvarli in un array di lunghezza prestabilita.
	 ...
	 * Deve essere della stessa dimensione dell'array che verr� restituito.
	 * @param lunghezza Dimensione dell'array di interi che verr� creato.
